...
def home():
    ...
    tooth = requests.post('http://icecream-api:5000/get_toothache', json = dict(cakes=cakes, shakes=shakes)).json()

    combo = Treats(cake_name=cakes.text, milk_name=shakes.text, toothache=tooth.text)#unsure about us of int
